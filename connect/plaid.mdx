...
{/* WITNESSED 2026-08-07 — evidence/witness/plaid-dashboard.md, the founder's own live dashboard,
    1 capture (shots/plaid-dashboard-keys-2026-08-07.png). It settles the nav (Developers → Keys,
    under a PLATFORM group heading), the page heading, all 3 card labels, the per-card controls and
    the Rotate button. It supersedes MERGED-plaid.md Step 0's "NO LABEL IS WITNESSED" ruling for
    THIS page only — the rest of the dashboard is still uncaptured. It also settles the dispute
    against the Console: there is no Team Settings item in that rail, so the runbook was right and
    the Console card is wrong. That is a PRODUCT defect; do not fix it by bending this page back. */}

{/* UNWITNESSED, still: everything else in the dashboard — the sign-up flow, the Trial-vs-Production
    plan page and any pricing, the Production access request form, Application Display Info. */}
