...
[The ingest route is the one route Postern serves without a host check](/reference/ports#the-push-ingest-route).
...
<Note>
  ...
  [Every failure answers identically on purpose](/reference/ports#the-push-ingest-route).
