...
Keep the gap between pushes under 48 hours. After 48 hours without a push the connection
...
<Columns cols={2}>
  ...
  <Card title="Connect an agent" href="/start/connect-an-agent">
    a key you created, granted health · a few minutes, plus a restart of the agent · one config
    block to paste
  </Card>
</Columns>
