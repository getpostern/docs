...
The list down the left has **Gatehouse**, then the six sectors, then **Sources**, **Agents & keys**,
...
Postern server in the middle. Nothing is connected yet, and no agent can reach anything until you
grant it.
...
<Columns cols={2}>
  ...
  <Card title="Set up remote access" href="/start/remote-access">
    Tailscale, and Funnel only if a hosted agent needs it · about 20 minutes, once · off by default
  </Card>
</Columns>
