...
<Frame caption="The form behind Mint a key: the Name field, the six sector toggles, and the expiry chips.">
  <img src="/images/gate-mint-key.png" alt="The Console's form for a new key: a Name field with the grey my-agent example, six unticked sector toggles, and four expiry chips." />
</Frame>
